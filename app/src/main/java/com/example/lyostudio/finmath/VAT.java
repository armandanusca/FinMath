...
/**
 * Created by leonardanusca on 28/05/16.
 */
public class VAT extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.test_vat);
        ...
        definition = (Button) findViewById(R.id.def_vat);

        definition.setOnClickListener(new View.OnClickListener()
        {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(getApplicationContext(),definitionVAT.class);
